...
//일반적으로는 변수를 만들고, 그 변수에 입력한 값을 적용하는 방식으로 사요합니다.
...
int main()
{
	...
	getchar(); //위에서 입력한 key 다음 동작인 enter키에 개한 값을 받아줍니다
	...
	printf("단어를 입력해주세요. >> ");
	gets(word); //문자열 입력
	puts(word); //전달받은 문장 출력

	//주의 사항  : c언어에서 한글을 입력하는 경우 한글 한 단어에 2칸을 소모합니다.
