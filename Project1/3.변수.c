...
//대표적인 자자료형
//이름 표현하는 형태의 크기     표현 범위
//int    정수     4byte         -2147483648~217483647
//float  실수     4byte         3.4*10 -3.4제곱 ~ 3.4 * 10 +38제곱   -->소수점 이하 6자리까지 정확하게 표현
...
int main()
{
    ...
    count = 5;
    //변수를 선언할 경우 자료형의 크기만큼 메모리 공간을 확보하여 그 위피에 변수의 이름을 
    //지정하게 됩니다.
    ...
    int hexa = 0x6; //숫자 앛에 0%가 붙으면 16진수
